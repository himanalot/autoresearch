...
3. **IMPORTANT:** Make sure you update the RESEARCH_PLAN.md document if you have any new experiments you've decided to run. Also update the file after receiving results.
